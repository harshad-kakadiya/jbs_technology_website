    ...
    return (
        <Box sx={{ display: "flex", justifyContent: "center" }}>
            <Box
                className="nav"
                sx={{
                    background:pathname === '/' ? '#FFF' : 'rgba(128, 128, 128, 0.2)',
                    boxShadow: "0 8px 32px 0 rgba(31, 38, 135, 0.15)",
                    backdropFilter: "blur(5.5px)",
                    padding: "10px 0",
                    position: (!scrolled && pathname === '/') ? "static" : "fixed",
                    width: "100%",
                    zIndex: 200,
                }}
            >
                                ...
                                {menuItems.map((item, index) => (
                                    ...
                                    >
                                        <NextLink href={item.path} passHref>
                                            ...
                                            >
                                                <ListItemText primary={item.text} sx={{color: pathname === '/'  ? scrolled ?'#FFF' : '#000' : "#FFF",fontWeight:700}} />
                                            </MuiLink>
                                        </NextLink>
                                    </ListItem>
                                ))}
                        ...
                        <Box sx={{ display: { lg: 'flex', xs: 'none' } }}>
                            <Button
                                ...
                                sx={{
                                    ...
                                    borderRadius: '30px',
                                    padding: '12px 30px',
                                    borderColor: pathname === '/'  ? scrolled ?'#FFF' : '#000' : "#FFF",
                                    color: pathname === '/'  ? scrolled ?'#FFF' : '#000' : "#FFF",
                                    ':hover': { backgroundColor: '#000', color: '#fff' },
                                }}
                                onClick={() => router.push("/contact")}
                            >
